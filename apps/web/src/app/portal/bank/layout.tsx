...
export default function BankLayout({ children }: { children: React.ReactNode }) {
  ...
  const [userName, setUserName] = useState("Director de Riesgo");
  const [institutionName, setInstitutionName] = useState("Banco Popular");
  ...
  useEffect(() => {
    ...
    if (stored) {
      try {
        ...
        setUserName(user.name || "Director de Riesgo");
      } catch {
        // ignore
      }
    }
