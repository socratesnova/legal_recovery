...
exports.CommunicationsModule = CommunicationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [communications_controller_1.CommunicationsController, delivery_webhook_controller_1.DeliveryWebhookController],
        providers: [
            communications_service_1.CommunicationsService,
            notification_dispatcher_1.NotificationDispatcher,
            delivery_reconciler_service_1.DeliveryReconcilerService,
        ],
        exports: [notification_dispatcher_1.NotificationDispatcher, delivery_reconciler_service_1.DeliveryReconcilerService],
    })
